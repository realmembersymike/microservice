...
export class EcsCdkStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const ecrRepo = new ecr.Repository(this, 'MicroServiceECRepo', {
     ...
     */
    const vpc = new ec2.Vpc(this, 'MicroServiceVPCNetwork', {
      cidr: '10.0.0.0/16',
      natGateways: 1,
    ...
    const cluster = new ecs.Cluster(this, "MicroServiceECSCluster", {
      vpc: vpc,
    });

    const logging = new ecs.AwsLogDriver({
      streamPrefix: "MicroServiceECSCluster"
    });
    ...
    const taskDef = new ecs.FargateTaskDefinition(this, "MicroServiceTaskDefinition", {
      taskRole: taskrole
    });
     ...
     * ACTUAL MAGIC 
     */
    const fargateService = new ecs_patterns.ApplicationLoadBalancedFargateService(this, "ALBFargateService", {
      cluster: cluster,
     ...
     * CODEBUILD PROJECT
     */
    const project = new codebuild.Project(this, 'MicroServiceECSTaskBuilder', {
